...
public class PieceWriter implements Closeable {
	...
	public PieceWriter(String baseDir, TorrentFile torrent) throws FileNotFoundException {
	...
	public void writePiece(Piece p) throws IOException {
		long startIndex = torrent.getPieceLength() * p.getIndex();
